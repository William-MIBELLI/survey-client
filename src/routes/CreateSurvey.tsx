...
import type { CreateSurveyMutation } from "../gql/generated";
import type { MutationCreateSurveyArgs } from "../gql/graphql";
...
const CreateSurvey = () => {
  const [createSurvey, { loading }] = useMutation<
  ...
  return (
    <div className="h-full w-full  flex flex-col justify-center items-center relative bg-yellow-300" popover="auto" id="create-popover" >
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <TextArea label="Description*" {...register("description")} error={errors.description} rows={5} />
          <Input type="date" label="Start date" {...register("startDate")} error={errors.startDate} />
          <Input type="date" label="End date" {...register("endDate")} error={errors.endDate}/>
